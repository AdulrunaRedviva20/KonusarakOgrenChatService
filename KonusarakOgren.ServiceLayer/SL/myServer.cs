...
using KonusarakOgren.CommonLayer.CL;
...
namespace KonusarakOgrenChatService.SL
{
    public class myServer
    {
        ...
        private string _ServerLabel => $"#Welcome to BK-Chat Services ({localEndpoint.Address}:{localEndpoint.Port})";
